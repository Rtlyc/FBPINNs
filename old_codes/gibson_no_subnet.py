...
from old_codes.main_05_14_encoder import circledataset
from old_codes.gibson_05_20 import gibsondataset
import copy
...
class Model():
    ...
    def train(self):
        ...
        #self._init_network()
        self.B = 1.0*torch.normal(0,1,size=(128,self.dim)) #0.5
